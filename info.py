...
BOT_TOKEN = environ.get('BOT_TOKEN', "8473091335:AAGSSmCiooXKtJgzLjxXWIJBFizeDHX_5Wg")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002974352702').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003141830968'))  # Log channel id (make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+Hk62uGnHHnk1ZTI1')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Auto:Auto@cluster0.l9bsmbl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
# ============================
GRP_LNK = environ.get('GRP_LINK' 'https://t.me/+jfEtsIP4QhJhZmE1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', '') # Owner link for the bot
